...
// Use a credit
router.post("/use", authMiddleware_1.verifyToken, creditController_1.useCredit);
// Purchase credits
router.post("/purchase", authMiddleware_1.verifyToken, creditController_1.purchaseCredits);
